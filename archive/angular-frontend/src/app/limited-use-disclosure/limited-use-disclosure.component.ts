...
@Component({
  selector: 'app-limited-use-disclosure',
  templateUrl: './limited-use-disclosure.component.html',
  styleUrls: ['./limited-use-disclosure.component.css']
})
export class LimitedUseDisclosureComponent implements OnInit,OnDestroy {
