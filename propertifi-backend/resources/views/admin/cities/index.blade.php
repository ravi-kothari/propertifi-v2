            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    @php
                    $cityPermit = Helper::checkPermission($adminId,15,'addd');
                    @endphp
                    @if($cityPermit)
                    <!--<a href="{{url('/admin/add-city')}}" class="btn icon btn-sm btn-outline-primary float-end">Add City</a>-->
                    @endif
