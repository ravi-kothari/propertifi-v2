            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <form id="searchForm" name="searchForm" class="float-start">
                        <div class="d-flex align-items-center  w-md-800px">
                            ...
                            <div class="position-relative w-md-200px me-md-2">
                                <input id="title" name="title" confirmation="false" class="form-control" placeholder="Search By Question">
                            </div>
                    ...
                    @if($userData->type != 'Agent')
                    @php
                    $faqPermit = Helper::checkPermission($adminId,7,'addd');
                    @endphp
                    @if($faqPermit)
                    <a href="{{url('/admin/add-faq')}}" class="btn icon btn-sm btn-outline-primary float-end">Add FAQ</a>
                    @endif
                    @endif
