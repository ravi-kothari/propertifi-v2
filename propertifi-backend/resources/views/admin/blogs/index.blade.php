            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    @php
                    $blogPermit = Helper::checkPermission($adminId,6,'addd');
                    @endphp
                    @if($blogPermit)
                    <a href="{{url('/admin/add-blog')}}" class="btn icon btn-sm btn-outline-primary float-end">Add Blog</a>
                    @endif
