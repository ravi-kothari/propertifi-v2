                ...
                <div class="col-12 col-md-12 order-md-2">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Property Manager</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <form class="form w-100" id="pageForm" action="#">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="basicInput">Email Verification</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" maxlength="5" name="zipcode" value="{{$rowData->zipcode}}" id="zipcode">
                        </div>
                    </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$rowData->p_contact_no}}" maxlength="10" name="p_contact_no" id="p_contact_no">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="basicInput">Enter Position</label>
                                <input type="text" class="form-control" value="{{$rowData->position}}" name="position" id="position">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                Temp Password: {{$rowData->temp_pass}}
                            </div>
                        </div>
                        
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="checkbox" @if($rowData->featured == 1) checked @endif  value="1" name="featured" id="featured"> &nbsp;Featured
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$rowData->seo_title}}" name="seo_title" id="seo_title">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="basicInput">SEO Description</label>
                                <textarea class="form-control" name="seo_description" id="seo_description">{{$rowData->seo_description}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="basicInput">SEO Keywords</label>
                                <textarea class="form-control" name="seo_keywords" id="seo_keywords">{{$rowData->seo_keywords}}</textarea>
                            </div>
                        </div>
...
<script>
    ...
    let returnURL = "{{url('/admin/edit-property-managers/'.$row_id)}}";
</script>
