                ...
                <div class="col-12 col-md-12 order-md-2">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/admin/agent-roles'); }}">User Roles</a></li>
...
<!-- end plugin js -->
<script>
    let saveDataURL = "{{url('/admin/edit-agent-role/'.$row_id)}}";
    let returnURL = "{{url('/admin/edit-agent-role/'.$row_id)}}";
</script>
