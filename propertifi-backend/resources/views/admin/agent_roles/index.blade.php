            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="{{url('/admin/add-agent-role')}}" class="btn icon btn-sm btn-outline-primary float-end">Add User Role</a>
...
$(document).ready(function(){
    filterData('simple');
	$('#page_main_title').html('User Roles');
});
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/agent_roles_paginate') }}",
