            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <form id="searchForm" name="searchForm" class="float-start">
                        <div class="d-flex align-items-center  w-md-800px">
                            ...
                            <div class="position-relative w-md-200px me-md-2">
                                <input id="title" name="title" confirmation="false" class="form-control" placeholder="Search By Heading">
                            </div>
                            <div class="position-relative w-md-200px me-md-2">
                    ...
                    @php
                    $testPermit = Helper::checkPermission($adminId,13,'addd');
                    @endphp
                    @if($testPermit)
                    <a href="{{url('/admin/add-testimonial')}}" class="btn icon btn-sm btn-outline-primary float-end">Add Testimonial</a>
                    @endif
...
$(document).ready(function(){
    filterData('simple');
	$('#page_main_title').html('Testimonials');
});
