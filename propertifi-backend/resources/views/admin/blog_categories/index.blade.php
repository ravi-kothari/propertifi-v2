            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    @endphp
                    @if($blogPermit)
                    <a href="{{url('/admin/add-blog-category')}}" class="btn icon btn-sm btn-outline-primary float-end">Add Blog Category</a>
                    @endif
...
$(document).ready(function(){
    filterData('simple');
	$('#page_main_title').html('Blog Categories');
});
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/blog_categories_paginate') }}",
