            ...
            <div class="card">
               <!--begin::Card body-->
                <div class="card-body">
                    ...
                    <a href="{{url('/admin/add-account-manager')}}" class="btn icon btn-sm btn-outline-primary float-end">Add Account Manager</a>
...
$(document).ready(function(){
    filterData('simple');
	$('#page_main_title').html('Account Managers');
});
...
function filterData(type = null){
	...
	$.ajax({
		...
		url: "{{ url('/admin/account_managers_paginate') }}",
