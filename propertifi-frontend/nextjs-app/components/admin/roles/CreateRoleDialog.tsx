...
import { createRole, getAvailablePermissions } from '@/lib/admin-api';
import { useToast } from '@/hooks/use-toast';
import type { AvailablePermissions } from '@/types/admin';
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <ScrollArea className="h-[500px] pr-4">
              <div className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="content_manager" {...field} />
                        </FormControl>
                        <FormDescription>
                          Lowercase with underscores (e.g., content_manager)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                {/* Role Settings */}
                <div className="space-y-4">
                  <h3 className="text-sm font-semibold text-gray-900">Role Settings</h3>
