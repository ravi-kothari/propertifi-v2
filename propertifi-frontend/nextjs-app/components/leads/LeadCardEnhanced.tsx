...
import { Zap, TrendingUp, Star, CheckCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      {lead.number_of_units && (
        <div className="mt-2 inline-flex items-center gap-1 text-xs text-gray-600 bg-gray-50 px-2 py-1 rounded">
