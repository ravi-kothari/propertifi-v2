...
const Hero: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (zipcode.trim()) {
      // Redirect to get-started or search page with zipcode
      router.push(`/get-started?zipcode=${encodeURIComponent(zipcode)}`);
    }
  };
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-br from-propertifi-blue/20 to-transparent"></div>
