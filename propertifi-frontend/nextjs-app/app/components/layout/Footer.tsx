...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-300 transition-colors">
        ...
        <div className="border-t border-slate-300 dark:border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col items-center md:items-start">
              <div className="font-heading text-xl font-bold text-slate-900 dark:text-white mb-2">
                Propertifi
              </div>
              <p className="text-sm text-slate-500 dark:text-slate-400">
                &copy; {currentYear} Propertifi. All rights reserved.
              </p>
            </div>
