...
@Component({
  selector: 'app-my-client-center',
  templateUrl: './my-client-center.component.html',
  styleUrls: ['./my-client-center.component.css']
})
export class MyClientCenterComponent implements OnInit,OnDestroy {
